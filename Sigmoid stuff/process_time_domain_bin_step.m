...
bin_step_td = extract_td_data("C:\Users\Test\OneDrive - Imperial College London\FYP\Sigmoid stuff\binary_step_td_output.csv");


hold on;
scatter(voltage_points, bin_step_td, 'r');
