function sigmoidaltimedomainoutput = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   SIGMOIDALTIMEDOMAINOUTPUT = IMPORTFILE(FILENAME) Reads data from text
%   file FILENAME for the default selection.
%
%   SIGMOIDALTIMEDOMAINOUTPUT = IMPORTFILE(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   sigmoidaltimedomainoutput = importfile('sigmoidal_time_domain_output.csv', 1, 544);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2020/03/02 13:33:42
...
sigmoidaltimedomainoutput = cell2mat(raw);
