function irisoutputtd = importfile1(filename, startRow, endRow)
%IMPORTFILE1 Import numeric data from a text file as a matrix.
%   IRISOUTPUTTD = IMPORTFILE1(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   IRISOUTPUTTD = IMPORTFILE1(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   irisoutputtd = importfile1('iris_output_td.csv', 2, 501);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2020/06/02 17:14:47
