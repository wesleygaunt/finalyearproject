function vmmx10 = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   VMMX10 = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   VMMX10 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   vmmx10 = importfile('vmm_x10.csv', 2, 901);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2020/06/10 19:30:54
