...
with open('train_iris.pickle', 'rb') as f:
...
with open('layer_1_W0_iris.csv', mode='w') as file:
    writer = csv.writer(file, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
    writer.writerow(layer_1_W0)
    
with open('layer_1_W1_iris.csv', mode='w') as file:
    writer = csv.writer(file, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
    writer.writerow(layer_1_W1)
    
with open('layer_1_W2_iris.csv', mode='w') as file:
    writer = csv.writer(file, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
    writer.writerow(layer_1_W2)
    
with open('layer_1_W3_iris.csv', mode='w') as file:
    writer = csv.writer(file, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
    writer.writerow(layer_1_W2)
...
with open('layer_2_W0_iris.csv', mode='w') as file:
    writer = csv.writer(file, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
    writer.writerow(layer_2_W0)
    
with open('layer_2_W1_iris.csv', mode='w') as file:
    writer = csv.writer(file, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)
    writer.writerow(layer_2_W1)
    
with open('X_iris.csv', mode='w',newline='') as file:
    writer = csv.writer(file)
    writer.writerows(X)
    
with open('y_python_iris.csv', mode='w',newline='') as file:
    writer = csv.writer(file)
    writer.writerows(out_layer_2)
    
with open('y_python_clipped_iris.csv', mode='w',newline='') as file:
    writer = csv.writer(file)
