function tdtovoltagesinglemultiplier1pF = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   TDTOVOLTAGESINGLEMULTIPLIER1PF = IMPORTFILE(FILENAME) Reads data from
%   text file FILENAME for the default selection.
%
%   TDTOVOLTAGESINGLEMULTIPLIER1PF = IMPORTFILE(FILENAME, STARTROW, ENDROW)
%   Reads data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   tdtovoltagesinglemultiplier1pF = importfile('td_to_voltage_single_multiplier_1pF.csv', 1, 83);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2020/05/21 15:59:37
...
tdtovoltagesinglemultiplier1pF = cell2mat(raw);
